  ...
  return (
    <section className='sticky top-24 lg:top-20'>
      <div className='container sticky top-24  mx-auto grid grid-cols-[90px,1fr]  md:grid-cols-[200px,1fr] lg:grid-cols-[280px,1fr]'>
        ...
        <div className='min-h-[88vh] max-h-[88vh] overflow-y-scroll p-1 grid gap-1 shadow-md scrollbarCustome bg-white py-2'>
          {
        ...
        <div className='sticky top-20'>
          ...
          <div>
           ...
           <div className='min-h-[75vh] max-h-[75vh] overflow-y-auto relative'>
            <div className=' grid grid-cols-1 ml-6 md:grid-cols-3 xl:grid-cols-4 p-4 gap-4  '>
                {
                  data.map((p, index) => {
                    return (
                      <CardProduct
